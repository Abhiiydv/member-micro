...
public class AuthenticationControllerTest {
	...
	Member m = new Member((long) 11, "Abhishek", "yadav", "Abhishek123", "123@Abhishek", "123@Abhishek", "Dwarka",
			...
			LocalDateTime.now());
	Member m2 = new Member((long) 12, "Aradhya", "yadav", "", "123@Aradhya", "123@Aradhya", "Dwarka", "Delhi", 12,
			"Delhi", new Date(12 - 11 - 2001), "Aradhya99@gmail.com", LocalDateTime.now(), LocalDateTime.now());
	Member m3 = new Member((long) 13, "Aditi", "yadav", "Aditi123", "123@Aditi", "123@Aradhya", "Dwarka", "Delhi", 12,
			"Delhi", new Date(12 - 11 - 2001), "Aditi99@gmail.com", LocalDateTime.now(), LocalDateTime.now());
	Member m4 = new Member((long) 13, "Aadi", "yadav", "Aditi123", "123@Aditi", "12345@Aradhya", "Dwarka", "Delhi", 12,
			"Delhi", new Date(12 - 11 - 2001), "Aditi979@gmail.com", LocalDateTime.now(), LocalDateTime.now());
	...
	@Test
	public void signupMemberFailureDuetoshortFirstname() {

		when(adminService.saveMember(m4)).thenReturn(m4);
		assertEquals(new ResponseEntity<>(HttpStatus.NOT_ACCEPTABLE), authcontroller.signUp(m4));
	...
	@Test
	public void signIn() {
		User req = new User((long) 11, "Abhishek123", "$10$TY3CCAVvSI7OKKUO.EoAUeU.//0DtXREmICTH0rQN2dPKbxXhv6kG",
				Role.ADMIN, "", "");
		User user = new User();
